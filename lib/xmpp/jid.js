...
JID.prototype.bare = function() {
    if (this.resource)
        return new JID(this.user, this.domain_custom, null);
    else
        return this;
};
...
JID.prototype.equals = function(other) {
    return this.user == other.user &&
        this.domain_custom == other.domain_custom &&
...
/**
 * http://xmpp.org/rfcs/rfc6122.html#addressing-domain_custom
 */
JID.prototype.setDomain = function(domain_custom) {
    this.domain_custom = domain_custom &&
        nameprep(domain_custom.split(".").
                 map(toUnicode).
                 join("."));
};
