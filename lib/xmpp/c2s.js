...
C2SStream.prototype.startStream = function(streamAttrs) {
	//This is the first function whuch is called when streamStart event is generated by Connection, which in turn is generated when Stream Parser genereates 'start' event
...
C2SStream.prototype.sendFeatures = function() {
	//This function is called in response to the first message by the client and called from C2SStream.prototype.startStream
...
C2SStream.prototype.onAuth = function(stanza) {
	console.log("In C2SStream onAuth");
	console.log(stanza);
	console.log(this.mechanisms);
    var matchingMechs = this.mechanisms.filter(function(mech) {
        return mech.name === stanza.attrs.mechanism;
    });
	console.log(matchingMechs);

    if (matchingMechs[0]) {
		console.log("selected mechanism");
