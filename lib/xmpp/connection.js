...
Connection.prototype.setupStream = function() {
    ...
    this.socket.addListener('data', function(data) {
		//console.log("Connection : data event generated");
        self.onData(data);
    });
...
Connection.prototype.send = function(stanza) {
    ...
    if (stanza.root) {
		...
		//console.log("Connection : send : directly writing stanza");
...
Connection.prototype.startParser = function() {
	console.log("In start Parser of Connection");
    var self = this;
    ...
    this.parser.addListener('start', function(attrs) {
         ...
         */
		//console.log("Connection : emitting streamStart");
		//'streamStart' is captured by C2SStream
...
Connection.prototype.startStream = function() {
	//console.log("Connection : startStream");
    var attrs = {};
