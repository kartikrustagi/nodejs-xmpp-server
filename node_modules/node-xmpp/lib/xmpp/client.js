...
function Client(params) {
    ...
    this.streamTo = this.jid.domain_custom;
	...
	if (params.host) {
		...
		['_xmpp-client._tcp'], self.jid.domain_custom, 5222);
...
Client.prototype.useFeatures = function() {
	...
	var offeredMechs = this.streamFeatures.
        ...
        if (this.mech) {
            ...
            this.mech.realm = this.jid.domain_custom;  // anything?
            this.mech.digest_uri = "xmpp/" + this.jid.domain_custom;
